...
public class test1 {
	// Create the data of the patient
		public static PatientData readPatient(){
			...
			//char reponse = 'O';
			int idpatient = 0, weight = 0, bloodPressure = 0; String dateMeasure = "01-01-2010";
			//while (reponse == 'O') {
	...
	public static void main(String[] args) {
		...
		char reponse = 'O'; 			Scanner sc = new Scanner(System.in);
		while (reponse == 'O') {
			System.out.println("Commencez la saisie");
				...
				try {
					...
					mapper.writeValue(new File("c:\\user.json"), aPatient);
					// display to console
